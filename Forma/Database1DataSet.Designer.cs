...
namespace Forma {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string Фамилия, string Имя, string Отчество, string Адрес, string Дата_рождения) {
            ...
            private void InitClass() {
                ...
                this.columnОтчество.MaxLength = 19;
                this.columnАдрес.MaxLength = 70;
                this.columnДата_рождения.MaxLength = 25;
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Дата_рождения {
                get {
                    try {
                        return ((string)(this[this.tableTable.Дата_рожденияColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Forma.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)) AND ((@IsNull_Дата_рождения = 1 AND [Дата рождения] IS NULL) OR ([Дата рождения] = @Original_Дата_рождения)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Фамилия], [Имя], [Отчество], [Адрес], [Дата рож" +
                "дения]) VALUES (@Id, @Фамилия, @Имя, @Отчество, @Адрес, @Дата_рождения);\r\nSELECT" +
                " Id, Фамилия, Имя, Отчество, Адрес, [Дата рождения] FROM [Table] WHERE (Id = @Id" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Адрес] = @Адрес, [Дата рождения] = @Дата_рождения WHERE (([Id] = @Original_Id) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)) AND ((@IsNull_Дата_рождения = 1 AND [Дата рождения] IS NULL) OR ([Дата рождения] = @Original_Дата_рождения)));
SELECT Id, Фамилия, Имя, Отчество, Адрес, [Дата рождения] FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Forma.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Фамилия, Имя, Отчество, Адрес, [Дата рождения] FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, string Original_Дата_рождения) {
        ...
        public virtual int Insert(int Id, string Фамилия, string Имя, string Отчество, string Адрес, string Дата_рождения) {
        ...
        public virtual int Update(int Id, string Фамилия, string Имя, string Отчество, string Адрес, string Дата_рождения, int Original_Id, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, string Original_Дата_рождения) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Адрес, string Дата_рождения, int Original_Id, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, string Original_Дата_рождения) {
            return this.Update(Original_Id, Фамилия, Имя, Отчество, Адрес, Дата_рождения, Original_Id, Original_Фамилия, Original_Имя, Original_Отчество, Original_Адрес, Original_Дата_рождения);
        }
    }
